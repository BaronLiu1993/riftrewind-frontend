  ...
  return (
    <div className="h-screen w-full font-lexend bg-gray-100 flex items-center justify-center p-5">
      <div className="relative w-full justify-center items-center max-w-md border-1 bg-gray-50 h-full bg-gradient-to-br overflow-hidden rounded-md">
        ...
        <div>
          <div>Macro Score is Computed With Consideration of Your</div>
          <div>
            as These capture duel strength, teamfight output, precision
            skillshots, and survivability death penalty.
          </div>
          <ol>
            <li>Kills per 10</li>
            <li>Assists per 10</li>
            <li>Deaths per 10</li>
            <li>Damage to champions per minute (DPM)</li>
            <li>Skillshots hit per 10</li>
            <li>Solo kills per 10</li>
            <li>Killing sprees per 10</li>
          </ol>
        </div>
